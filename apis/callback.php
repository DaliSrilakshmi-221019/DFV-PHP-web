...
$client->setClientId($_ENV['174953257347-99rb97jdgop6kd6jgppdt3smuqfmvv0v.apps.googleusercontent.com']);
$client->setClientSecret($_ENV['****uwOU']);
$client->setRedirectUri($_ENV['http://localhost/Fruits -ecommerce\apis']);
...
if (isset($_GET['code'])) {
    ...
    echo "No code parameter found in the URL.";
}*/
